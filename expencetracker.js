...
window.addEventListener('DOMContentLoaded', () => {
    axios.get("https://crudcrud.com/api/50e4d707553446e7bfeaacb87f5ebe80/expence")
        .then((response) => {
...
function addItem(e) {
    ...
    async function modifyList() {
        ...
        await axios.get("https://crudcrud.com/api/50e4d707553446e7bfeaacb87f5ebe80/expence")
            .then((response) => {
                response.data.forEach((ele) => {
                    if (ele.discription == obj.discription) {
                        check(obj);
                        axios.delete("https://crudcrud.com/api/50e4d707553446e7bfeaacb87f5ebe80/expence/"+`${ele._id}`)
                    }
                })
            })
        ...
        await axios.post("https://crudcrud.com/api/50e4d707553446e7bfeaacb87f5ebe80/expence", obj)
            .then((response) => {
...
// https://crudcrud.com/api/d9d38068e32c41ec8f5b5f7a762e8238
